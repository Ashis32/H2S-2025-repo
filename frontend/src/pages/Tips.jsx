        ...
        <div className={'tips'}>
          {role === 'teacher' && (
            <div>
              ...
              <p>
                We hope you enjoy using StudyBuddy. To help you get the most out
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    <li>
                      <strong>Be Aware of “Hallucinations”: </strong> StudyBuddy
                    ...
                    <li>
                      ...
                      StudyBuddy as a “fresh college grad.” As a recent college
                      graduate, StudyBuddy has general background knowledge but
                      ...
                      StudyBuddy can effectively apply the poetry grading rubric
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Customize StudyBuddy: </strong> Utilize the
              ...
              <i>
                <p style={{ textAlign: 'right' }}>StudyBuddy Team</p>
              </i>
            </div>
          )}
          {role === 'student' && (
            <div>
              ...
              <p>
                We hope you find StudyBuddy useful for improving your writing
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      StudyBuddy to receive feedback, make revisions, and improve
                      your work.
                    </li>
                    <li>
