...
const Privacy = () => {
  return (
    <div className="privacy">
      <h1>Privacy Statement for StudyBuddy</h1>
      <h2>
        <em>Effective Date: August 1, 2024</em>
      </h2>
      <p>
        Welcome to StudyBuddy! Your privacy is important to us. This Privacy
        Statement explains how we handle your information when you use our app.{' '}
      </p>

      <h2>Data Processing and Third-Party API Usage</h2>
      <p>
        When you use StudyBuddy, the text you input is sent to the Google Gemini
      ...
      <p>
        StudyBuddy utilizes Google's Gemini API to enhance your experience. The
      ...
      <p>Thank you for using StudyBuddy!</p>
      <p>
        <em>StudyBuddy Team</em>
      </p>
    </div>
  );
};
