...
const AboutUsModal = ({ isVisible, handleClose }) => {
  return (
    ...
    >
      ...
      <h2> Social Impact </h2>
      <p>
        StudyBuddy streamlines and enhances the grading process for writing
        ...
        By utilizing StudyBuddy, teachers save valuable time and can provide
      ...
      <p>
        ...
        can use to change the world.” StudyBuddy empowers teachers to dedicate
      ...
      <p>
        ...
        low-income, and immigrant students. StudyBuddy aims to{' '}
        <span className="boldLight">
      ...
      <p>
        StudyBuddy enables teachers to manage larger student populations
        ...
        StudyBuddy supports teachers in{' '}
      ...
      <p>
        StudyBuddy encourages teachers to transition to digital assignment
        submissions,{' '}
      ...
      <p>
        By promoting digital submissions, StudyBuddy helps mitigate these
